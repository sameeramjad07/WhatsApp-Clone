...
import com.example.sameerchat.databinding.ActivitySignInBinding;
import com.example.sameerchat.databinding.ActivitySplashScreenBinding;
                ...
                auth.createUserWithEmailAndPassword
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(SplashScreen.this, "User Created Successfully", Toast.LENGTH_SHORT).show();
                        }
                        else{
